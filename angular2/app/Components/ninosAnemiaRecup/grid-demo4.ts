...
export class GridDemo4 implements OnInit, OnDestroy,OnChanges {
    ...
    GetData() {
        this.loading=true;
        this.reporteService.autenticarGet4(this.IdReport,this.IdAnio,this.exportar).subscribe(
            data => {
    ...
    getColumns(): Array<Column> {
        return [
            ...
            new Column('EDAD','ED'),
            new Column('PROF. Rc','PROF_RC'),
            new Column('FECHA Rc','FECHA_RC'),
