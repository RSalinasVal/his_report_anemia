...
export class GridDemo2 implements OnInit, OnDestroy,OnChanges {
    ...
    GetData() {
        ...
        this.reporteService.autenticarGet2(this.IdAnio,this.IdEstab,this.IdDNI,this.exportar).subscribe(
            data => {
